...
class FilesController < ApplicationController
  ...
  def share
    ...
    raise RequestError.new(:bad_param, "Can not share th root folder") if file.id == session[:user].root_folder.id
  ...
  ##
  # Returns the list of the DDL links generated by the user
  def mylinks
    files_list = []
